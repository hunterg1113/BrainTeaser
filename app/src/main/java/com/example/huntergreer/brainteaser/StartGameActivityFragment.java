...
public class StartGameActivityFragment extends Fragment {
    ...
    private void playGame(final View v, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            choice4 = v.findViewById(R.id.choice4);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        Log.d(TAG, "onSaveInstanceState: curChoice1 = " + outState.get(CUR_CHOICE_1));
        Log.d(TAG, "onSaveInstanceState: curChoice2 = " + outState.get(CUR_CHOICE_2));
        Log.d(TAG, "onSaveInstanceState: curChoice3 = " + outState.get(CUR_CHOICE_3));
        Log.d(TAG, "onSaveInstanceState: curChoice4 = " + outState.get(CUR_CHOICE_4));
        ...
        Log.d(TAG, "onSaveInstanceState: curChoice1Tag = " + outState.get(CUR_CHOICE_1_TAG));
        Log.d(TAG, "onSaveInstanceState: curChoice2Tag = " + outState.get(CUR_CHOICE_2_TAG));
        Log.d(TAG, "onSaveInstanceState: curChoice3Tag = " + outState.get(CUR_CHOICE_3_TAG));
        Log.d(TAG, "onSaveInstanceState: curChoice4Tag = " + outState.get(CUR_CHOICE_4_TAG));
